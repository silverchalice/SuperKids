                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="likeRating" title="${message(code: 'assessment.likeRating.label', default: 'Like Rating')}" />
                        
                            <g:sortableColumn property="changeComment" title="${message(code: 'assessment.changeComment.label', default: 'Change Comment')}" />
                    ...
                    <g:each in="${assessmentInstanceList}" status="i" var="assessmentInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: assessmentInstance, field: "likeRating")}</td>
                        
                            <td>${fieldValue(bean: assessmentInstance, field: "changeComment")}</td>

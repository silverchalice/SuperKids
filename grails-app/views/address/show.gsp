            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="address.customer.label" default="Customer" /></td>
                            
                            <td valign="top" class="value"><g:link controller="customer" action="show" id="${addressInstance?.customer?.id}">${addressInstance?.customer?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="address.sponsor.label" default="Sponsor" /></td>
                            
                            <td valign="top" class="value"><g:link controller="sponsor" action="show" id="${addressInstance?.sponsor?.id}">${addressInstance?.sponsor?.encodeAsHTML()}</g:link></td>

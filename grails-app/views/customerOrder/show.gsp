                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:formatDate date="${customerOrderInstance?.dateCreated}" /></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="customerOrder.orderType.label" default="Order Type" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="customerOrder.products.label" default="Products" /></td>

    ...
    <g:form method="post">
            ...
            <div class="dialog">
                ...
                <table style=" width:380px;">
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top">
                            <g:link controller="home" action="a_change_c_password"
                                    id="${customerInstance?.id}">Change Password</g:link>
                        </td>
                    </tr>
                    <tr class="prop">
                        <td valign="top" class="name">
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top">
                            <g:checkBox name="hasCompletedCurrentAssessment"
                                        value="${customerInstance?.hasCompletedCurrentAssessment}"/>
                        </td>
                    </tr>
                    <tr class="prop">
                        <td valign="top" class="name">
                    ...
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label><g:message code="customer.deliveryAddress.street.label"
                                              default="Del Street"/></label>
                        </td>
                        <td valign="top">
                            <g:textField name="deliveryAddress.street"
                                         value="${customerInstance?.deliveryAddress?.street}"/>
                        </td>
                    </tr>
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label><g:message code="customer.deliveryAddress.street2.label"
                                              default="Del Street 2"/></label>
                        </td>
                        <td valign="top">
                            <g:textField name="deliveryAddress.street2"
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top">
                            <g:textField name="deliveryAddress.city"
        ...
        <div style="float:left; margin-left:10px; width:420px;">
            <table style="width: auto">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <g:checkBox name="doNotReceiveAdditionalInformation"
                                    value="${customerInstance?.doNotReceiveAdditionalInformation}"/></td>
                </tr>
                ...
                <tr class="prop"><td colspan="2"><g:textArea cols="" rows="" value="${customerInstance?.opNotes}"
                                                             name="opNotes"

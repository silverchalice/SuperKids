...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="${resource(dir: 'css', file: 'ui-lightness/jquery-ui-1.8.5.custom.css')}"/>
...
<g:form>
    ...
    <div class="callerNavBar">
        <g:link class="callerButton" style="margin-left:10px" action="finish_call"
        ...
        <g:if test="${queue && !start}">
            ...
            <img id="loader" style="position:absolute; left:1200px; padding-top:3px; height:25px; display:none;"
        ...
        <g:if test="${single}">
            ...
            <g:actionSubmit style="position:relative; left:1080px; width:100px" class="callerButton" id="submit"
                            action="save_assess_call" value="Finish"/>
        </g:if>
            ...
            <div class="dialog">
                <div id="column1" style="width:415px; float:left">
                    <table style="width:400px; margin: 10px 10px 0 0; margin-left:0">
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">
                                <label for="shipDate"><g:message code="customer.source.label"
                                                                 default="Shipping Date"/></label>
                            </td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top"
                                class="value ${hasErrors(bean: customerInstance, field: 'source', 'errors')}">
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">
                                <label for="fsdName"><g:message code="customer.fsdName.label"
                                                                default="FSD Name"/></label>
                            </td>
                            <td valign="top"
                                class="value ${hasErrors(bean: customerInstance, field: 'fsdName', 'errors')}">
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">
                                <label for="fsdTitle"><g:message code="customer.fsdTitle.label"
                                                                 default="FSD Title"/></label>
                            </td>
                            <td valign="top"
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top"
                                class="value ${hasErrors(bean: customerInstance, field: 'email', 'errors')}">
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">
                                <label for="district"><g:message code="customer.district.label"
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top"
                                ...
                                <g:textField class="textField" name="address.street"
                                             value="${customerInstance?.address?.street}" style="width:290px;"/>
                            </td>
                        </tr>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top"
                                ...
                                <g:textField class="textField" name="address.street2"
                                             value="${customerInstance?.address?.street2}" style="width:290px;"/>
                            </td>
                        </tr>
                        ...
                        <tr class="prop">
                            <td class="name">
                                <label for="address.state"><g:message code="address.state.label"
                                                                      default="State"/></label>
                            </td>
                            <td class="value">
                                <g:textField class="textField" name="address.state"
                                             value="${customerInstance?.address?.state}"
                    ...
                    <table style="width:400px; margin: 10px 10px 0 0; margin-left:0">
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">
                                <label for="studentsInDistrict"><g:message code="customer.studentsInDistrict.label"
                                                                           default="# of Students In District"/></label>
                            </td>
                            <td valign="top"
                                class="value ${hasErrors(bean: customerInstance, field: 'studentsInDistrict', 'errors')}">
                                <g:textField name="studentsInDistrict"
                                             value="${fieldValue(bean: customerInstance, field: 'studentsInDistrict')}"/>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                ...
                <div id="column2" style="width:500px; float:left">
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top"
                                ...
                                <label for="deliveryAddress.state"><g:message code="deliveryAddress.state.label"
                                                                              default="State"/></label>
                                <g:textField class="textField" name="deliveryAddress.state"
                    ...
                    <table style="margin:10px 10px 0 0; width:320px; position: relative; left:150px; border: none;">
                        <tbody>
                        <tr>
                            <td class="prop"
                                style=" background-image:url(${resource(dir: 'images', file: 'callnote-assess.png')}); background-repeat:no-repeat">
                                <h3 style="padding-top:10px; padding-left:10px">Operator Comments</h3>
                                <br/>
                                <g:textArea rows="" cols=""
                                            style="width:270px; height:250px; background:none; margin-left:10px"

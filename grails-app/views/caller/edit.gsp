                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="user"><g:message code="caller.user.label" default="User" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: callerInstance, field: 'user', 'errors')}">
                                    <g:select name="user.id" from="${com.superkids.domain.User.list()}" optionKey="id" value="${callerInstance?.user?.id}"  />
                                </td>
                            </tr>

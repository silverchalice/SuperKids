...
<html>
    ...
    <div id="content">
        ...
        <sks:hasNotPlacedCurrentOrder>
            <a href="${createLink(controller: 'product', action: 'check_out')}" title="Move to the next step" class="btn arrow top"><span>Proceed with order</span></a>
        </sks:hasNotPlacedCurrentOrder>

        <sks:hasNotPlacedCurrentOrder>
            <a href="${createLink(controller: 'home', action: 'order')}">&laquo; Back</a><a href="${createLink(controller: 'product', action: 'check_out')}" title="Move to the next step" class="btn arrow"><span>Proceed with order</span></a> </div>
        </sks:hasNotPlacedCurrentOrder>
         </div>

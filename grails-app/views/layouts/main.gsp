            ...
            <div class="homePagePanel">
                ...
                <div class="panelBody">
                    ...
                    <ul>
                        ...
                        <li><span class='menuButton'><a href="/report/exportCustomers?withAssessments=true" onclick="jQuery.ajax({type:'post', data:{'withAssessments': 'true','format': 'csv','extension': 'csv'}, url:'/report/exportCustomers',success:function(data,textStatus){jQuery('#downloadLink').html(data);},error:function(XMLHttpRequest,textStatus,errorThrown){}});return false;" class="excel">Download Excel</a></span></li>
                        <li><span class='menuButton'><a href="/report/exportTestCustomers" onclick="jQuery.ajax({type:'post', data:{'withAssessments': 'true','format': 'csv','extension': 'csv'}, url:'/report/exportTestCustomers',success:function(data,textStatus){jQuery('#downloadLink').html(data);},error:function(XMLHttpRequest,textStatus,errorThrown){}});return false;" class="excel">Download Excel (Test)</a></span></li>
                        <li><span class='menuButton'><a href="/report/exportCustomers" onclick="jQuery.ajax({type:'post', data:{'format': 'csv', 'extension': 'csv'}, url:'/report/exportCustomers',success:function(data,textStatus){jQuery('#downloadLink').html(data);},error:function(XMLHttpRequest,textStatus,errorThrown){}});return false;" class="excel">Excel (no assessments)</a></span></li>

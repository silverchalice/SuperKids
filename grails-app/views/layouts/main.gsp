...
<head>
    ...
    <script type="text/javascript" src="${resource(dir: 'js', file: 'sks.js')}"></script>
    <script type="text/javascript" src="${resource(dir: 'js', file: 'jquery-migrate-1.0.0.js')}">
    </script>
    <script>
...
<div id="grailsLogo" style="height:75px;"><g:link controller="home"><img style="float:left"
                                                                         src="${resource(dir: 'images/layout', file: 'AdminLogo.jpg')}"
                                                                         alt="SuperKids" border="0"/></g:link>
    ...
    <div class="homePagePanel">
        ...
        <div class="panelBody">
            ...
            <ul>
                ...
                <li><sks:formats controller="report" action="exportCalls" formats="['csv']"
                                 msg="Download CSV Call Log"/></li>
                <li><sks:formats controller="report" action="exportDNRCustomers" formats="['csv']"
                                 msg="CSV (DNR Mailing)"/></li>
                <li><sks:formats controller="report" action="exportPotentialParticipants" formats="['excel']"
                                 msg="Potential Participants"/></li>
                <li><hr/></li>
                <li><h1>Master Report</h1></li>
                <li><span class='menuButton'><a href="/report/exportCustomers?withAssessments=true"
                                                onclick="jQuery.ajax({
                                                  type: 'post',
                                                  data: {
                                                  ...
                                                  url: '/report/exportCustomers',
                                                  success: function (data, textStatus) {
                                                    jQuery('#downloadLink').html(data);
                                                  },
                                                  error: function (XMLHttpRequest, textStatus, errorThrown) {
                                                  }
                                                });
                                                return false;" class="excel">Download Excel</a></span></li>
                <li><span class='menuButton'><a href="/report/exportTestCustomers" onclick="jQuery.ajax({
                  type: 'post',
                  data: {'withAssessments': 'true', 'format': 'csv', 'extension': 'csv'},
                  url: '/report/exportTestCustomers',
                  success: function (data, textStatus) {
                    jQuery('#downloadLink').html(data);
                  },
                  error: function (XMLHttpRequest, textStatus, errorThrown) {
                ...
                return false;" class="excel">Download Excel (Test)</a></span></li>
                <li><span class='menuButton'><a href="/report/exportCustomers" onclick="jQuery.ajax({
                  type: 'post',
                  data: {'format': 'csv', 'extension': 'csv'},
                  url: '/report/exportCustomers',
                  success: function (data, textStatus) {
                    jQuery('#downloadLink').html(data);
                  },
                ...
                return false;" class="excel">Excel (no assessments)</a></span></li>

...
<html>
    ...
    <div id="help">
        ...
        <p>
            Fields marked with an asterisk (<span style="font-weight: bold">*</span>) are required so that we have the right address to send your samples to, and so that
        ...
        <h3>Approximate Number of Cafeterias, Food Courts, etc.</h3>
        ...
        <p>Samples are limited and subject to availabilty.</p>
    </div>
    </body>
</html>

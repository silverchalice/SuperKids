...
<html>
    ...
    <body>
        ...
        <div style="width:630px; height:480px; overflow:auto;">
           ...
           <p>&nbsp;</p>
            <div class="list">
                <g:each in="${productInstanceList}" var="productInstance">
                    ...
                    <div style="width:130px; float:left;"><br /><img src="${createLink(controller:'product', action:'displayImage', id:productInstance.id)}" align="left" /></div> ${productInstance.description}<br />
                    <div style="width:140px; text-align:right; float:right;"><h4>${productInstance.sponsor.name}</h4>                    

  ...
  <head>
    ...
    <div id="intro-container">
          <div id="intro"> <img src="${resource(dir:'images',file:'img_home_kids.jpg')}" alt="A fun group of middle school kids" />
            ...
            <p><strong>What is the SuperKids Whole Grain Sampling Program?</strong> SuperKids is a unique sampling program designed to introduce whole grain and higher-fiber options for school foodservice breakfast, lunch and snacks. In fact, SuperKids provides K–12 School foodservice directors with a free and convenient way to try <a href="${createLink(controller: 'home', action: 'superkids_products')}" title="View all our products">multiple products</a> made with the whole grain goodness of <a href="${createLink(controller: 'home', action: 'ultragrain')}" title="Learn more about Ultragrain">Ultragrain</a>&reg; and <a href="${createLink(controller: 'home', action: 'sustagrain')}" title="Learn more about Sustagrain">Sustagrain</a>&reg;—all from a variety of trusted food companies.</p>
        ...
        <div id="overview">
          ...
          <div class="col-01"> <a href="${createLink(controller: 'home', action: 'about')}"><img src="${resource(dir:'images',file:'img_kids_eating.jpg')}" alt="Kids happily eating lunch" /></a>
            ...
            <ul>
              ...
              <li><a href="${createLink(controller:'contactRequest', action:'create')}" title="Contact Us">Contact us </a></li>
            </ul>
          </div>
          <div class="col-02"> <a href="${createLink(controller: 'home', action: 'ultragrain')}"><img src="${resource(dir:'images',file:'img_wheat.jpg')}" alt="Wheat swaying in the wind" /></a>
            ...
            <ul>
              ...
              <li><a href="${createLink(controller: 'home', action: 'whole_grain_benefits')}" title="What is Sustagrain">What is Sustagrain</a></li>
            </ul>
          </div>
          <div class="col-03"> <a href="${createLink(controller: 'home', action: 'order')}"><img src="${resource(dir:'images',file:'img_pasta.jpg')}" alt="A pasta salad" /></a>
            ...
            <p>Order from our list <br />
              ...
              product samples</p>
            <ul>
                <li><a href="${createLink(controller: 'product', action: 'show', id: 45)}" title="Ultragrain Flour®: Healthy Choice® All-Purpose Flour Blend T-2">Healthy Choice® All-Purpose Flour Blend</a></li>

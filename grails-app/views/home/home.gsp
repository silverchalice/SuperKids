  ...
  <head>
	...
	<body>
		...
		<div id="contentInsetInner">
			...
			<img alt="sponsors" src="${resource(dir:'images',file:'sponsors.png')}" />
			...
			<br/><strong>To get started, click the login button in the upper-right corner.</strong>
            <br/><a target="_blank" style="font-weight: bold" href="/SuperKids/images/ChefJeffVideo.wmv">To see a video of Chef Jeff demonstrating recipes using Ultragrain® at SNA, please click here</a></p>

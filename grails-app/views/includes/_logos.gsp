...
<a href="http://www.dominos.com" target="_blank"><img style="height:40px" src="${resource(dir:'images',file:'logo_dominos.png')}" alt="Domino's Pizza logo" /></a>
<a href="http://www.europeanbakers.com" target="_blank"><img style="height:40px" src="${resource(dir:'images',file:'FB_foodservicelogo_PMS.png')}" alt="Flowers logo" /></a>

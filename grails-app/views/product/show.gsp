            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="product.assessments.label" default="Assessments" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="product.brochure.label" default="Brochure" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: productInstance, field: "brochure")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="product.imageAd.label" default="Image Ad" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: productInstance, field: "imageAd")}</td>

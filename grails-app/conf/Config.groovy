...
grails.plugins.springsecurity.interceptUrlMap = [
   ...
   '/home/promotion-tools-and-resources':                ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/home/additional-promotional-ideas':                 ['IS_AUTHENTICATED_ANONYMOUSLY'],
   ...
   '/customer/**':                                                         ['ROLE_ADMIN'],
   '/customerOrder/**':                                                    ['ROLE_ADMIN'],
   '/pageText/**':                                                         ['ROLE_ADMIN'],
   '/call':                                                 ['ROLE_ADMIN', 'ROLE_CALLER'],
   '/call/**':                                              ['ROLE_ADMIN', 'ROLE_CALLER'],
   '/caller/**':                                              ['ROLE_ADMIN', 'ROLE_CALLER'],
   '/report/**':                                              ['ROLE_ADMIN'],
   ...
   '/assessment/viewAssessment':                              ['ROLE_USER', 'ROLE_ADMIN'],

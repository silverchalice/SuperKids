...
grails.plugins.springsecurity.interceptUrlMap = [
   ...
   '/cart':                                              ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/shoppingCart/**':                                   ['IS_AUTHENTICATED_ANONYMOUSLY'],
   ...
   '/learn.cfm':                                         ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/order.cfm':                                         ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/assess.cfm':                                        ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/promote.cfm':                                       ['IS_AUTHENTICATED_ANONYMOUSLY'],
   ...
   '/product/**':                                        ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/find_school_district':                              ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/customer/**':                                       ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/call':                                              ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/call/**':                                           ['IS_AUTHENTICATED_ANONYMOUSLY'],
   ...
   '/assessment/assess_process':                         ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/assess':                                            ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/assess/**':                                         ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/assessment/lc':                                     ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/assessment/complete':                               ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/assessment/cc':                                     ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/assessment/ir':                                     ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/assessment/favorite':                               ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/assessment/broker_contact':                         ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/assessment/feedback':                               ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/assessment/reformulations':                         ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/assessment/other_products':                         ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/assessment/rewards':                                ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/assessment/finish':                                 ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/assessment/dnr/**':                                 ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/shopping/confirm':                                  ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/shopping/place_order':                              ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/shopping/thanks':                                   ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/product/brokerEditFromEdit/**':                     ['IS_AUTHENTICATED_ANONYMOUSLY'],
   '/product/brokerDeleteFromEdit/**':                   ['IS_AUTHENTICATED_ANONYMOUSLY'],
